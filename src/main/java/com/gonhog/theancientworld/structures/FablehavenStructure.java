...
public class FablehavenStructure extends Structure<NoFeatureConfig> {
    public FablehavenStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return FablehavenStructure.Start::new;
    }
    /**
    ...
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_MONSTERS = ImmutableList.of(
            new MobSpawnInfo.Spawners(EntityType.CREEPER, 100, 4, 9)
    ...
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(
            new MobSpawnInfo.Spawners(RegistryHandler.SATYR.get(), 100, 10, 15)
    );
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation(TheAncientWorld.MOD_ID, "fablehaven/start_pool")),
            ...
            TheAncientWorld.LOGGER.log(Level.DEBUG, "Fablehaven at " +
