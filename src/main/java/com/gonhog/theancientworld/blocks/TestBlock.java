...
public class TestBlock extends Block {
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader reader, List<ITextComponent> list, ITooltipFlag flags) {
        list.add(new TranslationTextComponent("message.test_block", Integer.toString(Config.TEST_BLOCK_GENERATE.get())));
    }
            ...
            if (tileEntity instanceof TestBlockTile) {
                INamedContainerProvider containerProvider = new INamedContainerProvider() {
                    ...
                    public ITextComponent getDisplayName() {
                        return new TranslationTextComponent("screen.theancientworld.test_block");
                    }

                    @Override
                    public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
                        return new TestBlockContainer(i, world, pos, playerInventory, playerEntity);
                    }
                };
