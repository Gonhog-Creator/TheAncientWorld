...
import com.gonhog.theancientworld.blocks.LivingPumpkinBlock;
import com.gonhog.theancientworld.blocks.TestBlock;
...
public class RegistryHandler {
    ...
    //Bows
    public static final RegistryObject<BowItem> BOW_OF_ARROWS = ITEMS.register("bow_of_arrows", () -> new BowOfArrows(new Item.Properties()));
